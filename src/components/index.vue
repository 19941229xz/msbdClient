  ...
  <div>
    ...
    <div class="mui-content pb">
      ...
      <div class="mui-slider-indicator mui-segmented-control mui-segmented-control-inverted">
        <a v-for="(item,index) in questionjobtypeList" @click="changeQuestionJobType(item,index)"
           :class="{'mui-active':position==item.id}"
      ...
      <ul class="mui-table-view mui-grid-view mui-grid-9">
        <div style="position: relative;">
          ...
          <li @click="isDeveloping" class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4"
              style="border:none;">
            <!-- <a href="#">
          ...
          <li @click="toRandomPractice" class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4 no-border">
            <a href="javascript:;">
        ...
        <div style="position: relative;">
          ...
          <li @click="toCourseList" class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4 no-border">
            <a href="javascript:;">
              <span class="mui-icon mui-icon-home"></span>
          ...
          <li @click="isDeveloping" class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4 no-border">
            <a href="javascript:;">
              ...
              <div class="mui-media-body">问答技巧</div>
            </a>
          </li>
...
<script>
  export default {
    ...
    methods: {
      ...
      toRandomPractice: function () {
        console.log(this.questionJobTypeSelectedId)
        var num = parseInt(Math.random()*(this.questionCount-0+1)+0,10)
        console.log(num)
        this.$router.push({
          path: '/randomPractice',
          query: {
