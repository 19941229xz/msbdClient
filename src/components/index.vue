	...
	<div>
		<div class="mui-content pb">
			...
			<div class="mui-slider-indicator mui-segmented-control mui-segmented-control-inverted">
				<a v-for="(item,index) in questionjobtypeList" @click="changeQuestionJobType(item,index)" :class="{'mui-active':position==item.id}" class="mui-control-item">
			...
			<ul class="mui-table-view mui-grid-view mui-grid-9">
				...
				<div style="position: relative;">
					<div @click="isDeveloping" class="center--btn-box green">
						<div class="wrap">
							<p>模拟考试</p>
							<p>4分</p>
						</div>
